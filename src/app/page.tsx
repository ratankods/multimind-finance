                ...
                >
                  ...
                  {showAccordion1 && coinData && (
                    <Accordion
                      type="single"
                      collapsible
                      className="w-full h-80 overflow-y-auto text-md no-scrollbar  bg-[#27272A] px-4 rounded-md mt-2 z-9 absolute"
                      style={{
                        position: "absolute",
                        width: "280px",
                        marginTop: "400px",
                    ...
                    >
                      {coinData?.map((coin: any) => (
                        <AccordionItem key={coin?.id} value={coin?.id}>
                          <AccordionTrigger
                            onClick={() =>
                              handleNetworkRender(coin?.name, "from")
                            }
                          >
                            <Image
                              src={coin?.logoURI}
                ...
                >
                  ...
                  {showAccordion2 && coinData && (
                    <Accordion
                      type="single"
                      collapsible
                      className="w-full h-80 overflow-y-auto text-md no-scrollbar bg-[#27272A] px-4 rounded-md  z-9 relative"
                      style={{
                        position: "absolute",
                        width: "280px",
                        marginTop: "430px",
